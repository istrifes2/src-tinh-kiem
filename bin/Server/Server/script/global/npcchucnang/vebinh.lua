...
function baodanh()
	...
	return end;
	Say("<npc>: Trong Tèng Kim, bªn lîi thÕ vÒ sè ng­êi tuy cã chiÕm ­u thÕ nh­ng sÏ nhËn ®­îc ®iÓm tİch lòy İt h¬n, c¸c h¹ muèn chän b¸o danh bªn nµo?",3,
