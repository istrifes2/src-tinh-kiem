...
function main()
print("Login => [Account= "..GetAccount().."], [Name= "..GetName().."], [UUID= "..GetUUID().."]")
LoginLog()
	RLTask();
...
function LoginLog()
	...
	local log = ""..date("%H:%M:%S").."\t Tµi kho∂n: "..szAccount.."\t Nh©n vÀt: "..szName.."\t UUID: "..dwID.."\t C p: \t"..nLevel.."\t M´n ph∏i: "..nFaction.."\t IP: "..nIP.."\t Xu: "..nExtPoint.."\t TÊng ti“n vπn: \t"..nMoney.."\n"
    logWrite(log)
end