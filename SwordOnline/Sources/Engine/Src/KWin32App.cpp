...
//m_uMouseHoverStartTime ∫¨“Â
//MOUSE_EVENT_NONE		--> Œ¥∑¢…˙ Û±ÍªÓ∂Ø ¬º˛
//MOUSE_EVENT_HAPPEND	--> ”– Û±ÍªÓ∂Ø ¬º˛
//MOUSE_HOVER_MSG_SENT	--> Œﬁ Û±ÍªÓ∂Ø ¬º˛µƒ≥÷–¯ ±º‰≥¨π˝¡À…Ë∂®µƒ ±º‰œﬁ÷∆£¨“—∑¢ÀÕ¡ÀWM_NCMOUSEHOVERœ˚œ¢
//∆‰À˚÷µ				--> Œﬁ Û±ÍªÓ∂Ø ¬º˛µƒ≥÷–¯ ±º‰Œ¥≥¨π˝…Ë∂®µƒ ±º‰œﬁ÷∆£¨¥À÷µ±Ì æŒﬁ Û±ÍªÓ∂Øµƒø™ º ±º‰
...
LRESULT KWin32App::MsgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SETCURSOR:
        ...
        {
            // »Áπ˚Õ‚≤ø π”√Œ“√«◊‘º∫µƒ Û±Í£¨»Áπ˚√ª”–∑µªÿTRUE£¨
            // ƒ«√¥æÕª·µº÷¬ Û±Í±ª…Ë÷√ªÿ¿¥
            return TRUE;
        }
		break;
...
void KWin32App::GenerateMsgHoverMsg()
{
	...
	{
		//¥À ±(m_uMouseHoverStartTime == MOUSE_EVENT_NONE)
